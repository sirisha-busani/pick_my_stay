...
function $4bbd6d22e42ff57c$export$2e2bcd8739ae039({ options: defaultOptions , defaultValue: defaultValue , value: value , multiple: multiple , search: search , onChange: onChange = $4bbd6d22e42ff57c$var$nullCb , onFocus: onFocus = $4bbd6d22e42ff57c$var$nullCb , onBlur: onBlur = $4bbd6d22e42ff57c$var$nullCb , closeOnSelect: closeOnSelect = true , placeholder: placeholder , getOptions: getOptions , filterOptions: filterOptions , useFuzzySearch: useFuzzySearch = true , debounce: debounce  }) {
    ...
    const [state, update] = (0, $a9A1a$react.useState)(()=>({
            option: null,
            search: "",
            focus: false
        }));
    ...
    const [options, fetching] = (0, $0b51441790e9d9fb$export$2e2bcd8739ae039)(defaultOptions, getOptions, debounce, state.search);
    const onSelect = (v)=>{
        const newOption = (0, $b0b2d97816871546$export$2e2bcd8739ae039)((0, $595e451383f14c00$export$2e2bcd8739ae039)(decodeURIComponent(v), options), state.option, multiple);
    ...
    const snapshot = {
        ...state,
        value: (0, $2664d3f4613d5d45$export$2e2bcd8739ae039)(state.option),
        fetching: fetching,
        highlighted: highlighted,
        options: (0, $d5af33248d9ae6a9$export$2e2bcd8739ae039)((0, $8ef71079b895e810$export$2e2bcd8739ae039)(middleware, options, state.search)),
        displayValue: (0, $53ccf5af3f1de595$export$2e2bcd8739ae039)(state.option, options, placeholder)
    };
    const valueProps = {
        tabIndex: "0",
        readOnly: !search,
        ...
        onChange: search ? ({ target: target  })=>setState({
                search: target.value
            }) : null
    };
    const optionProps = {
    ...
    (0, $a9A1a$react.useEffect)(()=>{
        setState({
            option: (0, $595e451383f14c00$export$2e2bcd8739ae039)(value === undefined ? defaultValue : value, options)
        });
    }, [
        value,
        defaultValue
